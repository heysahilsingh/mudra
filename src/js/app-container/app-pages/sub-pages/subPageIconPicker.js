  ...
  if (document.querySelector(".app .app-page")) {
    ...
    const pageWrapper = (() => {
      ...
      const header = (() => {
        ...
        // Page Heading
        const heading = createHTML("p", { class: "page-heading" }, "Select an Icon");
      ...
      const body = (() => {
        ...
        function handleClick() {
          const selectedIcons = sectionIcons.querySelectorAll(".section-icons .selected");

          if (selectedIcons.length > 0) selectedIcons.forEach((ele) => ele.classList.remove("selected"));

          this.classList.add("selected");

          if (pCallback && typeof pCallback === "function") pCallback(this.getAttribute("id"));
        }
