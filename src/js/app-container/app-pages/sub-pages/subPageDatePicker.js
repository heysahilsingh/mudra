    ...
    const pageWrapper = (() => {
      ...
      const body = (() => {
        ...
        const datesPredefined = (() => {
          ...
          const rows = {
            allTime: {
              datesArray: getDates(today, dbUserDetails.firstTransaction),
              name: "All time",
              id: "allTime",
            },
            thisWeek: {
            ...
            if (rows.hasOwnProperty(row)) {
              ...
              rowHTML.addEventListener("click", () => {
                ...
                if (callback && typeof callback === "function") {
                  callback({ dates: returnDatesArray, row: rows[row] });
                }

                // Remove/Add Class
                const selectedLi = body.querySelectorAll("li.selected");
                if (selectedLi) {
                  selectedLi.forEach((ele) => ele.classList.remove("selected"));
                }
                rowHTML.classList.add("selected");
