...
export function subPageDatePicker(parameter) {
  ...
  3. To prselect the dates in list customSingle, pass the date in array by using this property {selectedListDates : ["dd mmm yyyy"]}
  3.1. To prselect the dates in list customMultiple, pass the dates in array by using this property {selectedListDates : ["dd mmm yyyy", "dd mmmm yyyy", ...]}
  3.2. To prselect the dates in list customRange, pass the date in array by using this property {selectedListDates : ["from-to" / "dd mmmm yyyy-dd mmm yyyy"]}
          ...
          const rows = {
            ...
            customRange: {
              ...
              cFunction: (dates) => {
                ...
                // Run parameter callback
                if (callback && typeof callback == "function") {
                  callback({ dates: returnDatesArray, row: rows.customRange, rangeDates: [dates.dateFrom + "-" + dates.dateTo] });
                }
              },
            },
          };
