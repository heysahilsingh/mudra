...
export function subPageWalletPicker(pObject) {
  ...
  2. To provide seletedLists, pass the list id(s) like {selectedWalletIds: ["LIST_ID_1"] or ["LIST_ID_1", "LIST_ID_2"]}
        ...
        const wallets = () => {
          ...
          for (const wallet of dbWallets) {
            if (wallet.isActive === true) {
              ...
              // HTML Balance
              const balance = createHTML(
                "p",
                { class: "wallet-balance" },
                formatAmount(wallet.balance) + " " + dbUserDetails.currency
              );
              ...
              li.addEventListener("click", () => {
                ...
                if (selectMultiple && selectMultiple === true) {
                  ...
                  const selectedLi =
                    walletsList.querySelectorAll("li.selected");
