...
export function subPageCategoryPicker(pObject) {
  ...
  8. In callback function, you'll receive an array of selected category(ies) object(s).
  */
  ...
  if (document.querySelector(".app .app-page")) {
    ...
    const { pHeading, pCategoryType, pMode, pSelectMultiple, pPreSelected, pCallback } =
      pObject;
