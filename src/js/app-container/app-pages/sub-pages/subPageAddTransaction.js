...
import { dbCategories, dbDeleteTransaction, dbEntryType, dbSaveTransaction, dbUserDetails, dbWallets } from "../../../db.js";
...
export function subPageAddTransaction(pObject) {
    ...
    2. To call this function as a page, then {pAsParentPage: false}
    ...
    */
    ...
    function renderAddTransactionPage() {
        ...
        let addTransaction = {
            ...
            walletId: pEditTransaction?.walletId || dbUserDetails.defaultWallet,
        ...
        const pageWrapper = (() => {
            ...
            function bodyWrapper(tType) {
                ...
                const transactionDateText = createHTML("p", {
                    class: "transaction-date-text",
                    time: formatDate(addTransaction.date).time
                }, formatDate(addTransaction.date).date);
                ...
                if (pEditTransaction) {
                    ...
                    deleteButton.addEventListener("click", () => {
                        compConfirmDialogBox({
                            pButton1: "No",
                            pButton2: "Yes",
                            pMessage: "You won't be able to restore this transaction if deleted. Are you sure you want to delete?",
                            pCallback: () => {
                ...
                saveButton.addEventListener("click", () => {
                    ...
                    if (transactionAmount.value.trim() === '' || transactionAmount.value == "0") {
                        ...
                        addTransaction.amount = transactionAmount.value.replace(/,/g, '');
