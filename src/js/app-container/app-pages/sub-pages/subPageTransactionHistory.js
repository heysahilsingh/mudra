...
export function subPageTransactionHistory(parameter) {
  ...
  */
  ...
  function renderTransactionHistoryPage() {
    ...
    const { pTransactions, pFIlterDates, pFilterCategories, pFilterWallets } = parameter;
    ...
    const pageWrapper = (() => {
      ...
      const body = (() => {
        ...
        let dataFilters = {
          filterDate: pFIlterDates?.dates || getDates(dbAppSettings.lasTransaction, dbAppSettings.firstTransaction),
        ...
        function renderSectionTransactions() {
          ...
          const filteredDataTransactions = getTransactions({
            based: "date",
