    ...
    const pageWrapper = (() => {
      ...
      const body = (() => {
        ...
        function renderData() {
          ...
          netBalance.incomeData.textContent = `${formatAmount(newIncome)} ${dbUserDetails.currency
            }`;
          netBalance.expenseData.textContent = `${formatAmount(newExpense)} ${dbUserDetails.currency
            }`;
