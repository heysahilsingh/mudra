...
export let dbUserDetails = {
  ...
  defaultWallet: "WALLET_T1c4d0S9h0o4A1E01687609709369",
  userName: "Sahil",
...
export function dbSaveTransaction(pTransactionObject) {
  // console.log(dbTransactions["expense"])
  ...
  if (isExist) {
    ...
    isExist.id = pTransactionObject.id;
    isExist.amount = pTransactionObject.amount;
    isExist.description = pTransactionObject.description;
    isExist.date = pTransactionObject.date;
    isExist.categoryId = pTransactionObject.categoryId;
    isExist.walletId = pTransactionObject.walletId;
    isExist.entryType = pTransactionObject.entryType;
  } else {
    console.log("Transaction Added")
    dbTransactions[pTransactionObject.entryType].push(pTransactionObject)
  }
...
export function dbDeleteTransaction(pTransactionObject) {
  ...
  if (isExist) {
    ...
    dbTransactions = dbTransactions[pTransactionObject.entryType].filter(transaction => {
